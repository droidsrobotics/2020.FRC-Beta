...
public class DriveTrain extends SubsystemBase {
    private final CANSparkMax m_leftMaster = new CANSparkMax(1, MotorType.kBrushless); // front
    private final CANSparkMax m_leftFollower = new CANSparkMax(2, MotorType.kBrushless); // rear
